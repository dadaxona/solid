...
{
    public static $ROUTE_NAME = 'purchase.create.confirmation';
    ...
    public function getPreview($announcement)
    {
        ...
        $ans = [
            ...
            $this->translate("Maxsulot sotib olish hududi:") => $announcement->region->name??'-',
            $this->translate("Aloqa chiquvchi ma'lumoti:") => $announcement->contact,
        ];
        $text = $this->translate("#elon #sotib_olish \n");
