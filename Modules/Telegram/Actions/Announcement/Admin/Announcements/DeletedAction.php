...
class DeletedAction extends Action
{
    public static $ROUTE_NAME ='admin.announcements.deleted';
    ...
    public function makeViewParams($message)
    {
        ...
        $announcements_count = Announcement::query()->deleted()->count();
        ...
        return [
            ...
            'text' => "O'chirilgan e'lonlar: $announcements_count ta"
        ];
    }
    ...
    {
        $keyboard = [];
        $announcements = Announcement::query()->deleted()->orderBy('created_at', 'desc')->offset(($page - 1) * $limit)->limit($limit)->get();
