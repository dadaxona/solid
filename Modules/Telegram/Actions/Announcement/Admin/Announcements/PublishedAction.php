...
class PublishedAction extends Action
{
    public static $ROUTE_NAME ='admin.announcements.published';
    ...
    public function makeViewParams($message)
    {
        ...
        $announcements_count = Announcement::query()->published()->count();
        ...
        return [
            ...
            'text' => "E'lon qilingan elonlar: $announcements_count ta"
        ];
    }
    ...
    {
        $keyboard = [];
        $announcements = Announcement::query()->published()->orderBy('created_at', 'desc')->offset(($page - 1) * $limit)->limit($limit)->get();
