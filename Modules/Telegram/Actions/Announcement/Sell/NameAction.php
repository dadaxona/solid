...
{
    public static $ROUTE_NAME ='sell.create.name';
    ...
    public function makeView($message)
    {
        ...
        $announcement = $this->telegram_chat->announcements()->sells()->draft()->where('type', 'sell')->first();
        if($announcement){
            $id = $announcement->id;
    ...
    public function makeViewParams($message)
    {
        ...
        return [
            ...
            // ]),
            'text' => $this->translate("Mahsulotingiz nomi(kamida 3ta harf): ")
        ];
    }
