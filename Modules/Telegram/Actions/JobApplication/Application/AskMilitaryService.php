...
class AskMilitaryService extends Action
{
    public static $ROUTE_NAME ='start.menu.ask-military-service';
    ...
    {
        return (new AskJudgment($this->telegram, $this->telegram_chat, $this->telegram_user))->makeView($message);
    }
    ...
    public function makeViewParams($message)
    {
        ...
        return [
            ...
            'text' => $this->translate("Xarbiy xizmatga borganmisiz?")
        ];
    }
    public function proccessMessageData($message)
    {
        ...
        if($job_application)
            $job_application->update(['military_service' => $message_text]);
    }
}