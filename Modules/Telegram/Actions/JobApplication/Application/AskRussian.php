...
class AskRussian extends Action
{
    public static $ROUTE_NAME ='start.menu.ask-russian';
    ...
    {
        return (new AskEnglish($this->telegram, $this->telegram_chat, $this->telegram_user))->makeView($message);
    }
    ...
    public function makeViewParams($message)
    {
        ...
        return [
            ...
            'text' => $this->translate("Rus tilida suxbatlashish darajangiz  (% ko‘rsating)")
        ];
    }
    public function proccessMessageData($message)
    {
        ...
        if($job_application)
            $job_application->update(['russian_level' => $value]);
    }
}