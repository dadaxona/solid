...
class AskWord extends Action
{
    public static $ROUTE_NAME ='start.menu.ask-word';
    ...
    {
        return (new AskExcel($this->telegram, $this->telegram_chat, $this->telegram_user))->makeView($message);
    }
    ...
    public function makeViewParams($message)
    {
        ...
        return [
            ...
            'text' => $this->translate("Word dasturini bilishingiz darajasi\n (% ko‘rsating)")
        ];
    }
    public function proccessMessageData($message)
    {
        ...
        if($job_application)
            $job_application->update(['word_level' => $value]);
    }
}